    ...
    <div class="container-fluid">
        ...
        <?php
            if(isset($_SESSION["username"])){
                ...
                echo "<span class='badge rounded-pill text-bg-secondary'>$logged_in</span>";
            }
            else{
                $not_logged_in = "Sie sind nicht eingeloggt";
                echo "<span class='badge rounded-pill text-bg-secondary'>$not_logged_in</span>";
            }
        ?>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#"><a id = "homepage" href="../homepage/Homepage.php"> Homepage </a></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><a id = "news" href="../NewsSite/News.php"> News </a></a>
                </li> 
                <li class="nav-item">
                    <a class="nav-link" href="#"><a id = "login" href="../Login/Login.php"> Login </a></a>
                </li> 
                <li class="nav-item">
                ...
                <?php 
                    if (isset($_SESSION["username"])) { ?>
                        <li class="nav-item">
                            <div class="logout">
                                <a class="btn btn-secondary" href="?logout=true">Logout</a>
                            </div>
                        </li>
                    <?php }?>
            </ul>
