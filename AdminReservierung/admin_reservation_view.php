...
<html lang="de">
    <head>
        ...
        <link rel="stylesheet" href="../css/admin_reservation_view.css">
    ...
    <div class="container">
        ...
        <div class="signup-form">
            <div class ="box">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><strong>Zurück zur Reservierungsverwaltung</strong></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        <tr>
                            ...
                            <td><a href="./AdminReservierungsVerwaltung.php">Reservierungsverwaltung</a></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
                ...
                <br>
                <div class="text-center">Zurück zur <a href="./AdminReservierungsVerwaltung.php">Reservierungsverwaltung</a></div>
            </div>
        </div>
    </div>
</body>
